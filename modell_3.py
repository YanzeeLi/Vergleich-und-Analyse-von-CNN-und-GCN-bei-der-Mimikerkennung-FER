'''
Model_3 is implemented entirely based on the gcn layer.
...
input_tensor_face_mp = keras.layers.MaxPool2D(pool_size=(2, 2), strides=(2, 2), padding='valid')(input_tensor_face)
...
# define gcn layer
face = gcn_net(input_tensor_face_mp, D, A, 12544, depth_network)
...
network = keras.Model([input_tensor_face, input_tensor_eyebrow, input_tensor_eye, input_tensor_nose, input_tensor_mouth], 
                      opt_tensor)
