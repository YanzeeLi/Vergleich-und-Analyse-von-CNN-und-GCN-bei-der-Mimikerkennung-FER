'''
Model_5 is a variant of model_2.
But the face data is not considered in the feature extraction process.
'''
...
A[0][2], A[0][3], A[1][3], A[2][0], A[3][0], A[3][1] = 0, 0, 0, 0, 0, 0
D[0][0], D[1][1], D[2][2], D[3][3] = 2, 3, 3, 2
...
new_tensor = layers.Reshape((4, 512))(new_tensor)

# gcn layer
gcn_layer = GraphConv.g_conv(new_tensor, D, A, 4)
